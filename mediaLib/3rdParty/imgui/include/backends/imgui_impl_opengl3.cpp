...
void    ImGui_ImplOpenGL3_RenderDrawData(ImDrawData* draw_data)
{
    ...
    // glUseProgram(last_program); // This may no longer be a valid shader anymore.
    // glBindTexture(GL_TEXTURE_2D, last_texture); // This may not be a valid texture anymore.
#ifdef IMGUI_IMPL_OPENGL_MAY_HAVE_BIND_SAMPLER
    if (bd->GlVersion >= 330)
