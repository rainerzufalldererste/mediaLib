...
typedef MEMORYMODULE * PMEMORYMODULE;
...
/**
 * Retrieves the size of a string resource with a given language.
 * If the language is unknown: use DEFAULT_LANGUAGE.
 */
DWORD MemoryStringRequiredCapacity(PMEMORYMODULE, UINT, WORD);
